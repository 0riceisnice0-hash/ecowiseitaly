...
bundle=/home/customer/ecowise-deploy-20260823-v28
root=/home/customer/www/ecowiseitaly.com/public_html
previous_theme=ecowise-custom-v28
next_theme=ecowise-custom-v29
candidate="$bundle/candidate"
archive="$bundle/ecowise-custom-theme-2026-08-23-v28.zip"
expected_sha=adee4fb2b4038a6fd2a3e9fb30208b976df1b18dd25ec3fb02f1beadb8c274a5
...
grep -q '^Version: 1.1.5$' "$candidate/ecowise-custom/style.css"
...
test "$(wp theme get "$next_theme" --field=version)" = '1.1.5'
...
trap - EXIT
echo 'EcoWise Italy owner media release 1.1.5 deployed as ecowise-custom-v29.'
